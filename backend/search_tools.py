...
class CourseSearchTool(Tool):
    ...
    def _format_results(self, results: SearchResults) -> str:
        ...
        for doc, meta in zip(results.documents, results.metadata):
            ...
            # Build structured source for the UI
...
class CourseOutlineTool(Tool):
    """Tool for getting complete course outlines including title, link and all lessons"""
    ...
    def get_tool_definition(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "description": "Get complete course outline with title, course link, and all lessons for a specific course",
            "input_schema": {
                "type": "object",
                "properties": {
                    "course_title": {
    ...
    def execute(self, course_title: str) -> str:
        ...
        Args:
            course_title: The course title to get the outline for
            
        Returns:
            Formatted course outline or error message
        """
        # First resolve the course name using existing method
        resolved_title = self.store._resolve_course_name(course_title)
        if not resolved_title:
            return f"No course found matching '{course_title}'"
        
        # Get the specific course metadata
        try:
            ...
            # Store source for UI
            source_obj = {
                "display": f"{resolved_title} - Course Outline",
